...
import { CustomDirective2 } from '@jompx/constructs';
...
export function tag(name: string): Directive {
    const value = { name };
    return CustomDirective2.getDecorator(directiveName, value);
}

export default class TagDirective extends CustomDirective2 {
...
//         return FlagDirective.getValue<FlagDirectiveValue>(directiveName, directives);
//     }
// }
